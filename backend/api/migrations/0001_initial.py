# Generated by Django 5.2.7 on 2025-11-05 21:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('PO', 'Product Owner'), ('SM', 'Scrum Master'), ('DEV', 'Developer')], default='DEV', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('PO', 'Product Owner'), ('SM', 'Scrum Master'), ('DEV', 'Developer')], max_length=3)),
